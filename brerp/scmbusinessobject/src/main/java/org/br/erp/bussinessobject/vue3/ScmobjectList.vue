<template>
  <div>
    ...
    <!--字典弹窗-->
    <ScmobjectModal @register="registerModal" @success="handleSuccess"/>
  </div>
</template>

<script lang="ts" name="bussinessobject-scmobject" setup>
  //ts语法
  import {ref, computed, unref, toRaw, nextTick} from 'vue';
  import {BasicTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import ScmobjectModal from './components/ScmobjectModal.vue';
  import {columns,searchFormSchema} from './Scmobject.data';
  import { downloadFile } from '/@/utils/common/renderUtils';
  import {list, deleteScmobject, batchDeleteScmobject, getExportUrl,getImportUrl, getChildList,getChildListBatch} from './Scmobject.api';
  ...
  async function handleDelete(record) {
    await deleteScmobject({id: record.id}, importSuccess);
  }
  ...
  async function batchHandleDelete() {
    ...
    await batchDeleteScmobject({id: ids}, importSuccess);
  }
  /**
   * 导入
   */
