...
public class SystemApiController {
    ...
    public Result<Object> updateStatus(@RequestParam("tablename")String tablename,
                               @RequestParam("statusfield")String statusfield,
                               @RequestParam("statusvalue")String statusvalue,
                               @RequestParam("idfield")String idfield,
                               @RequestParam("idvalue")String idvalue){
        sysBaseApi.updateTableStatus(tablename,statusfield,statusvalue,idfield,idvalue);
