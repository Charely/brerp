...
public class WarehouseController extends JeecgController<Warehouse, IWarehouseService> {
	...
	//@RequiresPermissions("org.br.erp:warehouse:add")
	...
	//@RequiresPermissions("org.br.erp:warehouse:edit")
	...
	//@RequiresPermissions("org.br.erp:warehouse:delete")
	...
	//@RequiresPermissions("org.br.erp:warehouse:deleteBatch")
    ...
    * @param warehouse
    */
    //@RequiresPermissions("org.br.erp:warehouse:exportXls")
    ...
    * @return
    */
    //@RequiresPermissions("warehouse:importExcel")
