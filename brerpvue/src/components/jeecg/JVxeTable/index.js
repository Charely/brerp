...
import CVxeMaterialSelectCell  from './components/cells/CVxeMaterialSelectCell'
import VxeBatchSelectCell  from './components/cells/CVxeBatchSelectCell'
...
export const AllCells = {
  ...
  ...mapCell(JVXETypes.materialSelect,CVxeMaterialSelectCell),
  ...mapCell(JVXETypes.batchSelect,VxeBatchSelectCell),
