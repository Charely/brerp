...
//自定义组件
import CSelectUser from '../../views/erp/base/custom/CSelectUser.vue'
...
//import LinkBillList from '../../views/erp/base/custom/LinkBillList.vue'
...
export default {
  install(Vue) {
    ...
    //自定义组件
    Vue.component('CSelectUser',CSelectUser)
    Vue.component('CSelectMaterial',CSelectMaterial)
    Vue.component('CSelectVendor',CSelectVendor)
    Vue.component('CSelectCustomer',CSelectCustomer)
    //Vue.component('LinkBillList',LinkBillList)
