  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item label="内部供应商" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="innervendorid">
          <c-select-vendor v-model="model.innervendorid" placeholder="请选择内部供应商"></c-select-vendor>
        </a-form-model-item>
