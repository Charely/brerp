<template>
  <a-card class="j-inner-table-wrapper" :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="plus" @click="handleOutStock('0')">出库</a-button>
      <a-button type="primary" icon="plus" @click="handleOutStock('1')">取消出库</a-button>
      <a-button type="primary" @click="handleinvoucher('1')">生成存货出库凭证</a-button>
      <a-button type="primary" @click="handleinvoucher('1')">取消生成存货出库凭证</a-button>
    ...
    <!-- 表单区域 -->
    <scmoutinventory-modal ref="modalForm" @ok="modalFormOk" />
...
import ScmoutinventoryModal from './modules/ScmoutinventoryModal'
import ScmoutinventoyitemSubTable from './subTables/ScmoutinventoyitemSubTable'
...
export default {
  ...
  components: {
    ScmoutinventoryModal,
    ScmoutinventoyitemSubTable,
  },
  data () {
    return {
      ...
      expandedRowKeys: [],
      url: {
        list: '/inventory/scminventoy/list/out',
