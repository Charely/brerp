<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" @click="handleinstock">委外材料出库</a-button>
    ...
    <scmoutsource-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import ScmoutsourceModal from './modules/ScmoutsourceModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          ...
          outstockurl:'/outsource/scmoutsource/outstock',
        },
        dictOptions:{},
        superFieldList:[],
      }
    ...
    methods: {
      ...
      handleinstock(){
        ...
        postAction(this.url.outstockurl,{ids:ids}).then(res=>{
          if(res.success){
