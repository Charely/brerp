<template>
  <a-card :bordered="false">
    ...
    <scmpurinvoice-modal ref="modalForm" @ok="modalFormOk" />
  </a-card>
</template>
...
import ScmpurinvoiceModal from './modules/ScmpurinvoiceModal'
import '@/assets/less/TableExpand.less'

export default {
  name: "ScmpurinvoiceList",
  ...
  data () {
    return {
      ...
      url: {
        list: "/po/scmpurinvoice/list",
        delete: "/po/scmpurinvoice/delete",
        deleteBatch: "/po/scmpurinvoice/deleteBatch",
        exportXlsUrl: "/po/scmpurinvoice/exportXls",
        importExcelUrl: "po/scmpurinvoice/importExcel",
  ...
  methods: {
    ...
    getSuperFieldList () {
      let fieldList = [];
      fieldList.push({ type: 'string', value: 'purorgid', text: '采购组织', dictCode: '' })
      ...
      fieldList.push({ type: 'string', value: 'deptid', text: '采购部门', dictCode: '' })
      fieldList.push({ type: 'string', value: 'emptid', text: '采购人员', dictCode: '' })
