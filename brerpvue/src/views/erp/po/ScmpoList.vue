<template>
  <a-card class="j-inner-table-wrapper" :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="plus" @click="handlePrint('scmpo')">打印预览</a-button>
      ...
      <a-table ref="table" size="middle" bordered rowKey="id" class="j-table-force-nowrap" :scroll="{ x: true }"
        ...
        <template slot="expandedRowRender" slot-scope="record">
          <a-tabs tabPosition="top">
            <a-tab-pane tab="采购订单分录" key="scmpoitem" forceRender>
              <scmpoitem-sub-table :record="record" />
            </a-tab-pane>
          </a-tabs>
        </template>
        <!-- 内嵌table区域 end -->
    ...
    <!-- 表单区域 -->
    <scmpo-modal ref="modalForm" @ok="modalFormOk" />
...
import ScmpoModal from './modules/ScmpoModal'
import ScmpoitemSubTable from './subTables/ScmpoitemSubTable'
