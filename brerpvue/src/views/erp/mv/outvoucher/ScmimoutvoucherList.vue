<template>
  <a-card :bordered="false">
    ...
    <scmimoutvoucher-modal ref="modalForm" @ok="modalFormOk"/>
  </a-card>
</template>
...
<script>
  ...
  import ScmimoutvoucherModal from './modules/ScmimoutvoucherModal'
  import '@/assets/less/TableExpand.less'

  export default {
    name: "ScmimoutvoucherList",
    mixins:[JeecgListMixin],
    components: {
      ScmimoutvoucherModal
    },
    data () {
      return {
        description: '出库凭证管理页面',
        // 表头
        columns: [
          {
            title: '#',
