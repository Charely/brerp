  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/base/warehouse/list",
          delete: "/base/warehouse/delete",
          deleteBatch: "/base/warehouse/deleteBatch",
          exportXlsUrl: "/base/warehouse/exportXls",
          importExcelUrl: "base/warehouse/importExcel",
