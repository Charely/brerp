  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/base/mvperiod/list",
          addperiod:'/base/mvperiod/addperiod',
          delete: "/base/mvperiod/delete",
          deleteBatch: "/base/mvperiod/deleteBatch",
          exportXlsUrl: "/base/mvperiod/exportXls",
          importExcelUrl: "base/mvperiod/importExcel",
          opernurl:'/base/mvperiod/changeperiodstate',
        },
        dictOptions:{},
        superFieldList:[],
      }
