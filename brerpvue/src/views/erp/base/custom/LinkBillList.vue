        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="24">
            <a-form-item label="单据编号" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <a-input placeholder="请输入单据编号查询" v-model="queryParam.preqcode"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="商品信息" :labelCol="{ span: 5 }" :wrapperCol="{ span: 18, offset: 1 }">
              <a-input placeholder="编码|名称|" v-model="queryParam.materialparam"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
...
export default {
  ...
  data () {
    return {
      ...
      columns: [
        ...
        {
          title: '单据编号', dataIndex: 'preqCode', width: 100,
        },
        { title: '制单人', dataIndex: 'createby', width: 145 },
        { title: '需求部门', dataIndex: 'preqDeptName', width: 100 },
        { title: '需求人员', dataIndex: 'preqEmpName', width: 70 },
        {
          title: '数量合计', dataIndex: 'totalqty', width: 70, customRender: function (text, record, index) {
            // console.log("yyc:" + text);
            return parseFloat(text, 2);
          }
        },
        {
          title: '金额合计', dataIndex: 'totalValue', width: 70, customRender: function (text, record, index) {
            return parseFloat(text, 2);
          }
        },
        {
          title: '产品编号', dataIndex: 'materialcode', width: 100, ellipsis: true
        },
        {
          title: '产品名称', dataIndex: 'materialname', width: 100, ellipsis: true
        },
        {
        ...
        {
          title: '数量', dataIndex: 'qty', width: 80, customRender: function (text, record, index) {
            return parseFloat(text, 2);
          }
        },
        {
          title: '分录金额', dataIndex: 'itemValue', width: 100, ellipsis: true
        },
      ],
      columnsDetail: [
  ...
  methods: {
    show (type, subType, organType, status,companyid) {
