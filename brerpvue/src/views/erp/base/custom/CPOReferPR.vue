  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: '采购部门', dataIndex: 'prdeptname', width: 100 },
        { title: '采购人员', dataIndex: 'prempname', width: 70 },
        {
          title: '表头备注', dataIndex: 'prremark', width: 70, customRender: function (text, record, index) {
            // console.log("yyc:" + text);
            return parseFloat(text, 2);
          }
        },
        {
          title: '物料编号', dataIndex: 'materialcode', width: 70,
        },
        {
          title: '物料名称', dataIndex: 'materialname', width: 100, ellipsis: true
        },
        {
          title: '采购数量', dataIndex: 'prqty', width: 100, ellipsis: true
        },
        {
          title: '单价', dataIndex: 'prprice', width: 80, customRender: function (text, record, index) {
            return parseFloat(text, 2);
          }
        },
        {
          title: '分录金额', dataIndex: 'prvalue', width: 100, ellipsis: true
        },
      ],
      columnsDetail: [
